...
public class ThereWasAnOldLadyTest {
	...
	/**
	 * Declare and initialize two streams to redirect the standard output and error
	 * streams
	 */
	...
	public void testPrintSong() {
		...
		assertEquals("printSong() output didn't match the expected.", expectedOutput,
	...
	public void testMain() {
		...
		assertEquals("main() output didn't match the expected.", expectedOutput,
				outContent.toString().replace("\r", ""));
